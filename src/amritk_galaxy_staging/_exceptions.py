...
class DemoAPIScalarGalaxyError(Exception):
    pass


class APIError(DemoAPIScalarGalaxyError):
    message: str
...
class WebSocketConnectionClosedError(DemoAPIScalarGalaxyError):
...
class WebSocketQueueFullError(DemoAPIScalarGalaxyError):
